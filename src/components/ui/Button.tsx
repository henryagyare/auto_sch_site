...
export default function Button({
  ...
  return (
    <button
      className={`inline-flex cursor-pointer items-center justify-center rounded-lg px-5 py-2.5 text-sm font-semibold leading-none transition-colors ${variantClasses[`${variant}-${theme}`]} ${className}`}
      {...props}
    >
      {children}
    </button>
