...
const reasons = [
  ...
  },
  {
    ...
    description:
      "Small class sizes and dedicated staff ensure every student is known, supported, and celebrated.",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid min-h-[520px] items-center gap-12 py-24 lg:grid-cols-2">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl">
              <Image src="/placeholder.jpg" alt="Students at Action Academy" fill className="object-cover" priority />
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              <Image src="/placeholder.jpg" alt="School documents" fill className="object-cover opacity-60" />
